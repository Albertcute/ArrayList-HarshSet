                ...
                switch (usEr){
                    case 'A':
                        ...
                        if(addNum == 0 || addNum == 1){
                            ...
                            Integers.put(num,addNum);
                            System.out.println("Num" + num + "=>" + addNum + " Successfully added to the HashMap");
                        }
                        else{
                            for(int i =2; i <= j; i++){
                                if(addNum%i == 0){
                                    ...
                                    int num = input.nextInt();
                                    Integers.put(num, addNum);
                                    System.out.println("Number"+ num + "=>" + addNum + " is successfully added to HashMap");
                                    PrimeNum = 1;
                                    break;
                                }
                            }
                   ...
                   System.out.println(Integers);
                    ...
                    default:
                        System.out.println("Please input a proper choices!");
